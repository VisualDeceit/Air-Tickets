...
@interface PriceMapTicketTableViewCell()
...
@implementation PriceMapTicketTableViewCell
...
//    _price = price;
//    
//    _priceLabel.text = [NSString stringWithFormat:@"%ld руб.", (long)price];
//    _placesLabel.text = [NSString stringWithFormat:@"%@ - %@", price.origin.code, price.destination.code];
//    
//    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
//    dateFormatter.dateFormat = @"dd MMMM yyyy hh:mm";
//    _dateLabel.text = [dateFormatter stringFromDate:price.departure];
//}
