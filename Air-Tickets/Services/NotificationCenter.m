...
//  Air-Tickets
//
//  Created by Alexander Fomin on 09.07.2021.
//
...
///Осуществляется запрос на получение доступа для отправления уведомлений, который будет происходить в момент первого запуска приложения
